...
class ClientCommunicator {
    ...
    ClientCommunicator(int port) throws SocketException {
        this.socket = SystemUtil.createDatagramSocket(port);
    }

    private static RequestReplyMessage constructClientMessage(ByteString id, ByteString payload) {
    ...
    private static RequestReplyMessage parseClientPacket(byte[] packetData, int offset, int length) {
    ...
    private static long getCheckSum(ByteString id, ByteString payload) {
